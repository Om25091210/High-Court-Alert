...
public class NoticeAdapter extends RecyclerView.Adapter<NoticeAdapter.ViewHolder>{
    ...
    public void onBindViewHolder(@NonNull NoticeAdapter.ViewHolder holder, int position) {
        ...
        holder.message.setText("अतः उक्त अपराध क्रमांक के पीड़ित को स्वयं मय वैध पहचान पत्र के साथ या अपने अधिवक्ता के माध्यम से दिनांक - " + date + " को उच्च न्यायालय, बिलासपुर में   के हेल्प डेस्क या (DLSA) " +
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        TextView district,station,crime_no,crime_yr,case_type,case_yr,notice_dt,hearing_dt,advocate_name,message;
